...
$("#slider2").ready(function(){
	//guardar el slider en una variable y seccion en variable
	var slider = $('#slider2');
	var seccioner = $('.slider_cont2');
	//buscar cantidad de secciones
	var seccion = slider.find('.slider_cont2');
	//contar el numero de secciones
	var n = seccion.length;
	//ancho del slider
	var ws = 100 * n;
	...
	var next = $('#btnNext2');
	//Movemos el ultimo seccion al primer lugar
	$('#slider2 .slider_cont2:last').insertBefore('#slider2 .slider_cont2:first');
	//le damos un margen negativo para ver el segundo elemento, que vendría a ser la primera imagen
	slider.css('margin-left', '-'+100+'%');
	...
	function moverD() {
		$(slider).animate({
			...
			$('#slider2 .slider_cont2:first').insertAfter('#slider2 .slider_cont2:last');
			slider.css('margin-left', '-'+100+'%');
	  });
	}
	//mover boton derecho
